            ...
            @foreach($images as $img)
                <div class="col-md-3 col-sm-6">
                    <div class="card shadow-sm">
                        ...
                        @else
                            <img src="https://via.placeholder.com/150?text={{ strtoupper(pathinfo($img->file_name, PATHINFO_EXTENSION)) }}"
                                class="card-img-top">
                        @endif
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <!-- ✅ FIXED DELETE BUTTON -->
                                <button class="btn btn-sm btn-danger w-50 delete-file" data-id="{{ $img->id }}">
                                    Delete
                                </button>
                            </div>
                        </div>
